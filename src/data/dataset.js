...
},
{
  ...
  "description": "La serpiente de jardín (Storeria dekayi) es una serpiente no venenosa que se encuentra en América del Norte, especialmente en áreas urbanas y jardines. Son pequeñas y suelen tener un color marrón o gris con manchas en la parte posterior. Estas serpientes son inofensivas para los seres humanos y son apreciadas por su papel en el control de poblaciones de insectos y pequeños roedores. Son tímidas y generalmente prefieren evitar el contacto con los humanos. La serpiente de jardín es un ejemplo de serpiente que prospera en entornos urbanos y es considerada beneficiosa para el equilibrio ecológico.",
...
//ANIMALES FRUGIVOROS
{
  ...
  "description": "El perezoso es un mamífero conocido por su estilo de vida tranquilo y sus movimientos extremadamente lentos. Se encuentran en América Central y del Sur, donde habitan principalmente en los árboles de las selvas tropicales. Los perezosos son herbívoros y se alimentan principalmente de hojas, brotes y frutas. Son animales solitarios y pasan la mayor parte de su vida colgados boca abajo en las ramas de los árboles. A pesar de su lentitud, los perezosos han desarrollado adaptaciones únicas, como garras fuertes y una baja tasa metabólica, que les permiten sobrevivir en su hábitat.",
...
},
{
  ...
  "description": "El colibrí es una pequeña ave conocida por su tamaño diminuto, su colorido plumaje y su habilidad de vuelo excepcional. Estas aves se encuentran en las Américas, desde Alaska hasta Tierra del Fuego. Los colibríes son conocidos por su capacidad de suspensión en el aire, su vuelo rápido y sus patrones de vuelo acrobáticos. Tienen una dieta principalmente nectarífera, y son importantes polinizadores de flores en sus hábitats. A menudo son apreciados por su belleza y su relación con la primavera y las flores en muchas culturas.",
...
},
{
  ...
  "description": "El loro es un ave conocida por su inteligencia y su capacidad de imitar sonidos, incluyendo el habla humana. Se encuentran en regiones tropicales y subtropicales de todo el mundo. Los loros son aves sociales que a menudo forman fuertes lazos con sus cuidadores y otros loros. Son herbívoros y se alimentan principalmente de frutas, semillas y nueces. Los loros son populares como mascotas debido a su naturaleza juguetona y su habilidad para aprender trucos y palabras.",
...
},
{
  ...
  "description": "El Tigre Siberiano, también conocido como tigre de Amur, es una de las especies más imponentes y majestuosas del reino animal. Es reconocido por su gran tamaño y belleza, así como por su fuerza y agilidad. Su pelaje naranja con rayas negras lo hace inconfundible y lo convierte en uno de los animales más reconocidos del mundo. Se estima que quedan menos de 500 tigres siberianos en estado salvaje debido a la caza furtiva y la destrucción de su hábitat",
...
},
{
  ...
  "description": "El lobo es un animal salvaje que se encuentra en diversas partes del mundo. Tiene un comportamiento social único y es conocido por su aullido característico. Los lobos son cazadores habilidosos y forman manadas donde se organizan para cazar presas más grandes. Son animales poderosos y tienen un rol importante en el equilibrio de los ecosistemas..",
...
},
{
  ...
  "description": "Patas traseras más cortas que las delanteras, cuello largo y pelo áspero gris o pardo con manchas negras; desprende un olor muy desagradable y emite un peculiar sonido parecido a una risa histérica; es nocturno y agresivo, y ocasionalmente carroñero; habita en África y Asia.Las potentísimas mandíbulas de la hiena le permiten triturar grandes huesos con facilidad.",
  "imageUrl": "https://www.bioparcvalencia.es/wp-content/uploads/2017/06/interiores-animal-bioparc-valencia-hiena-manchada-01.jpgATON",
  "facts": {
    "habitat": "Montaña",
...
},
{
  ...
  "description": "Poseen una vista extremadamente aguda que les permite visualizar potenciales presas a distancia, por ejemplo el águila real posee dos puntos focales en sus ojos, uno para mirar de frente y otro para localizar la mirada hacia los costados escudriñando a la distancia.",
...
},
{
  ...
  "description": "El puma (Felis concolor) El cuerpo es alargado, la cabeza es pequeña, el rostro es corto y el cuello y la cola son alargados. Las patas posteriores son más grandes que las anteriores y están poderosamente construidas. Las orejas son pequeñas, cortas y redondas. Las hembras tienen tres pares de mamas.",
...
//ANIMALES HERBÍVOROS
{
  ...
  "description": " La VACA es un animal mamífero, nace vivo del vientre de la madre. Es también vertebrado porque tiene huesos y herbívoro porque se alimenta de hierba y pastos. Es un animal muy grande y pesado.",
...
},
{
  ...
  "description": "Se pueden encontrar en la actualidad búfalos salvajes y búfalos domésticos y se les puede localizar en muchas partes del mundo. Se trata de un animal cuadrúpedo y mamífero, además de rumiante. Son muy parecidos a los toros pero los búfalos no tienen papada y sus orígenes se fijan hace 4500 años, en Asía, concretamente en las actuales India y Pakistán, aunque en la actualidad también están presente en el resto de continentes de la tierra.",
...
},
{
  ...
  "description": "Mamífero roedor que vive en los bosques de coníferas. Son animales muy activos y ágiles que están adaptados perfectamente a vivir en los árboles..",
...
},
{
  ...
  "description":"El tucán grande usa su pico con gran habilidad para atrapar pequeñas presas y separar trozos de comida. Vive en parejas o en bandadas de 20 aves. Vuela en una sola fila, con el pico recto. Duerme con la cabeza vuelta y el pico apoyado en la espalda.",
